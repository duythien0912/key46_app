...
class ProtectYourself extends StatelessWidget {
  Widget _getImage(String svgAssetName) => AspectRatio(
        ...
        child: Container(
          color: whoBlue,
          child: SvgPicture.asset(svgAssetName, package: 'WHOFlutter'),
        ),
      );

  // Widget get _washHandsImage => _getImage('lib/assets/svg/wash_hands.svg');

  Widget get _elbowImage => _getImage('lib/assets/svg/elbow.svg');

  Widget get _avoidTouchImage => _getImage('lib/assets/svg/avoid_touch.svg');

  Widget get _maskImage => _getImage('lib/assets/svg/mask.svg');

  Widget get _distanceImage => _getImage('lib/assets/svg/social_distance.svg');
  ...
  Widget _getAnimation(String animationName) => AspectRatio(
        ...
        child: Container(
          color: whoBlue,
          child: RiveAnimation(
            'lib/assets/animations/$animationName.flr',
