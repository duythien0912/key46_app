...
class S {
  ...
  String get locationSharingPageBackgroundImage {
    return Intl.message(
      'lib/assets/onboarding/onboarding_location.png',
  ...
  String get notificationsPagePermissionRequestBackgroundImage {
    return Intl.message(
      'lib/assets/onboarding/onboarding_notifications.png',
  ...
  String get travelAdvicePageListItem1Image {
    return Intl.message(
      'lib/assets/travel_advice/self-monitor.png',
  ...
  String get travelAdvicePageListItem2Image {
    return Intl.message(
      'lib/assets/travel_advice/quarantine.png',
  ...
  String get travelAdvicePageListItem3Image {
    return Intl.message(
      'lib/assets/travel_advice/doctor.png',
  ...
  String get newsFeedSliverListNewsFeedItemImagePath1 {
    return Intl.message(
      'lib/assets/news_press/news_situation_reports.png',
  ...
  String get newsFeedSliverListNewsFeedItemImagePath2 {
    return Intl.message(
      'lib/assets/news_press/rolling_updates.png',
  ...
  String get newsFeedSliverListNewsFeedItemImagePath3 {
    return Intl.message(
      'lib/assets/news_press/news_articles.png',
  ...
  String get newsFeedSliverListNewsFeedItemImagePath4 {
    return Intl.message(
      'lib/assets/news_press/press_briefings.png',
